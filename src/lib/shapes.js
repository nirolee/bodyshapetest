...
export const SHAPES = {
  hourglass:         { name: 'Hourglass',         slug: 'hourglass',          aka: [], group: 'hourglass',
    def: 'Bust and hips within about an inch of each other, and a waist at least 9 inches smaller than the bust or 10 inches smaller than the hips.' },
  top_hourglass:     { name: 'Top hourglass',     slug: 'hourglass',          aka: [], group: 'hourglass',
    def: 'Bust larger than hips by more than an inch (but under 10), with a waist at least 9 inches smaller than the bust.' },
  bottom_hourglass:  { name: 'Bottom hourglass',  slug: 'hourglass',          aka: [], group: 'hourglass',
    def: 'Hips larger than bust by 3.6 inches or more, a waist at least 9 inches smaller than the hips, and a high hip that is not much wider than the waist.' },
  ...
  triangle:          { name: 'Triangle',          slug: 'pear',               aka: ['pear'], group: 'pear',
    def: 'Hips larger than bust by 3.6 inches or more, without the waist definition that would make it a bottom hourglass or spoon.' },
  inverted_triangle: { name: 'Inverted triangle', slug: 'inverted-triangle',  aka: ['apple (in some systems)', 'V-shape'], group: 'inverted-triangle',
