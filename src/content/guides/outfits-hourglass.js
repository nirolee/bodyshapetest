export default {
 "path": "/shapes/hourglass/outfits/",
 "en": {
  "meta": {
   "title": "Hourglass Body Shape Outfits: What Tends to Suit a Defined Waist",
   "description": "Styling conventions for an hourglass — bust and hips close, waist 9–10 inches smaller — organised by what the defined waist does for a silhouette, what works against it, and what to do if you would rather not emphasise it."
  },
  "layout": {
   "eyebrow": "Outfits · Hourglass",
   "h1": "What tends to suit an hourglass shape",
   "lead": "An hourglass, under the rules, is a body whose bust and hips match and whose waist sits at least 9 inches below one of them. The one thing that relationship gives you is a waist that garments can follow. Most of the conventional advice comes down to whether a piece follows it or covers it — and both are legitimate choices.",
  ...
  "blocks": [
   ...
   {
    "t": "h2",
    "s": "Following the waist"
   },
   {
    "t": "p",
    "s": "Wrap styles, belted coats, high-rise trousers with the top tucked, fitted knits, and dresses with a seam at the natural waist are the conventional choices, because each one narrows where the body does. The tape measure is a useful guide to where “natural waist” is: it is the narrowest circumference you measured, usually a little above the navel, not where trousers happen to sit."
   },
   {
    "t": "h2",
    "s": "Keeping the ends balanced"
   },
   {
    "t": "p",
   ...
   {
    "t": "h2",
    "s": "If you would rather not emphasise it"
   },
   {
    "t": "p",
   ...
   },
   {
    "t": "ul",
    "items": [
     "Which of the three you are, in numbers: <a href=\"/shapes/hourglass/\">hourglass body shape</a>",
