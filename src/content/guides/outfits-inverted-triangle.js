export default {
 "path": "/shapes/inverted-triangle/outfits/",
 "en": {
  "meta": {
   "title": "Inverted Triangle Body Shape Outfits: Balancing a Wider Bust, or Using It",
   "description": "Styling conventions for an inverted triangle — bust at least 3.6 inches wider than hips — organised by what tends to add width below, what keeps the top simple, and what suits leaving the proportion as it is."
  },
  "layout": {
   "eyebrow": "Outfits · Inverted triangle",
   "h1": "What tends to suit an inverted triangle shape",
   "lead": "An inverted triangle, under the rules, has a bust at least 3.6 inches wider than the hips, with a waist not sharply defined against the bust. The conventional advice is the pear advice turned upside down: add visual weight below to match the width above, keep the top simple, or leave the proportion and dress the upper body well. Which of those you want is yours to decide.",
  ...
  "blocks": [
   ...
   {
    "t": "h2",
    "s": "If you would rather use the upper body"
   },
   {
    "t": "p",
   ...
   },
   {
    "t": "ul",
    "items": [
     "The rule and the apple naming problem: <a href=\"/shapes/inverted-triangle/\">inverted triangle body shape</a>",
     "The other “apple”: <a href=\"/shapes/apple/outfits/\">apple outfits</a>",
     "Measuring the bust so the boundary is right: <a href=\"/how-to-measure/\">how to measure</a>"
    ]
   },
   {
    "t": "h2",
   ...
   {
    "t": "p",
    "s": "Not sure you are inverted triangle? The <a href=\"/\">calculator</a> reports how close your measurements sit to the next shape, and each shape has its own outfit page."
   },
   {
    "t": "ul",
    "items": [
