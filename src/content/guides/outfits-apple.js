export default {
 "path": "/shapes/apple/outfits/",
 "en": {
  "meta": {
   "title": "Apple Body Shape Outfits: What Tends to Suit a Waist That Is the Widest Point",
   "description": "Styling conventions for an apple (FFIT oval or diamond) — waist larger than the hips — organised by what draws a longer line through the middle, what puts the eye at the shoulders and legs, and what to do if you would rather not."
  },
  "layout": {
   "eyebrow": "Outfits · Apple",
   "h1": "What tends to suit an apple shape",
   "lead": "An apple, in the sense this site uses, has a waist that measures more than the hips: oval if the bust is at least as wide as the waist, diamond if the waist leads both. The conventional advice is about line rather than balance — a longer line through the middle, and attention at the shoulders, neckline and legs, which measure narrower. None of it is required; all of it is explained.",
  ...
  "blocks": [
   ...
   {
    "t": "h2",
    "s": "A longer line through the middle"
   },
   {
    "t": "p",
    "s": "Empire lines, shift and A-line dresses, waistless coats, open front cardigans and jackets, tunics over slim trousers. Each avoids a horizontal break at the widest circumference. Fabrics with some drape do this better than stiff ones, which can stand away from the body at the hip and add width there."
   },
   {
    "t": "h2",
    "s": "Shoulders, neckline and legs"
   },
   {
    "t": "p",
   ...
   {
    "t": "h2",
    "s": "If you do want to mark a waist"
   },
   {
    "t": "p",
   ...
   },
   {
    "t": "ul",
    "items": [
     "Oval versus diamond, in numbers: <a href=\"/shapes/apple/\">apple body shape</a>",
  ...
  "faq": [
   ...
   [
    ...
    "Both are in use. This site uses apple for a waist wider than the hips (FFIT oval or diamond). Some calculators use it for an inverted triangle, where the bust leads. The advice for the two differs, so check which a guide means."
   ],
   [
    "Are these rules?",
