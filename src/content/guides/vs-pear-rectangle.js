 ...
 "en": {
  ...
  "tableData": {
   ...
   "rows": [
    ...
    [
     "waist",
     "0 ≤ bust − waist < 9 and 0 ≤ hips − waist < 10",
     "0 ≤ hips − waist < 9 (with the waist more defined it becomes spoon or bottom hourglass)"
    ],
    [
  ...
  "blocks": [
   ...
   {
    "t": "h2",
    "s": "Why this boundary is so crowded"
   },
   {
    "t": "p",
   ...
   {
    "t": "h2",
    "s": "What to do with a result within 2 cm"
   },
   {
    "t": "p",
   ...
   {
    "t": "h2",
    "s": "Does it change what suits you?"
   },
   {
    "t": "p",
   ...
   },
   {
    "t": "ul",
    "items": [
     "<a href=\"/shapes/pear/\">Pear body shape</a> · <a href=\"/shapes/rectangle/\">Rectangle body shape</a>",
     "Measuring the bust: <a href=\"/how-to-measure/\">how to measure</a>"
    ]
   }
  ],
  "faq": [
   ...
   [
    ...
    "No. They are adjacent categories in a garment-sizing system, separated by a cut-off, and the rules rank neither."
   ]
  ]
 }
};
