export default {
 "path": "/shapes/rectangle/outfits/",
 "en": {
  "meta": {
   "title": "Rectangle Body Shape Outfits: Adding a Waist, or Dressing the Straight Line",
   "description": "Styling conventions for a rectangle — bust, waist and hips within a narrow range — organised by what tends to create the appearance of a waist and what tends to suit the straight line as it is."
  },
  "layout": {
   "eyebrow": "Outfits · Rectangle",
   "h1": "What tends to suit a rectangle shape",
   "lead": "A rectangle, under the rules, has bust and hips within 3.6 inches of each other and a waist smaller than both by less than 9 and 10 inches. The differences are moderate all round, which means garments are not led anywhere in particular by the body. The conventional advice therefore splits cleanly: build a waist if you want one, or use the straight line, which suits a great deal.",
  ...
  "blocks": [
   ...
   {
    "t": "h2",
    "s": "What tends to work against either goal"
   },
   {
    "t": "p",
   ...
   },
   {
    "t": "ul",
    "items": [
     "Why rectangle is the most common result: <a href=\"/shapes/rectangle/\">rectangle body shape</a>",
     "If the bust measurement is close to a boundary: <a href=\"/pear-vs-rectangle/\">pear vs rectangle</a>",
     "Finding the narrowest point: <a href=\"/how-to-measure/\">how to measure</a>"
    ]
   }
  ],
  "faq": [
   [
    "What should a rectangle shape wear?",
    "Either pieces that create a waist — a belt at the narrowest point, a wrap top, a nipped jacket, a peplum — or pieces that use the straight line, such as column dresses and straight trousers with a straight top. The measurements do not push the outfit either way, so both are open."
   ],
   [
   ...
   [
    ...
    "It is one of the shapes that wears one best. Bust, waist and hips are close, so the dress hangs without pulling or gapping."
   ],
   [
